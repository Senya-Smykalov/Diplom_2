...
public class CreateBadOrderTest {
    ...
    @DisplayName("Cоздание заказа с невалидным ингредиентом")
    @Description("Негативная проверка - создание заказа с невалидным ингредиенто")
    @Test
    public void createBadOrder() {
        orderClient.createBadOrder();
    }
